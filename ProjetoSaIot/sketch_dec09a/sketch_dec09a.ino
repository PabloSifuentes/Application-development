 ...
 * 
 * Autores: Pablo Sifuentes, Carlos Menon, Willian Oliveira.
...
#define ONE_WIRE_BUS 14 // usando o GPIO 14
...
const char* mqtt_topic = "le_dados_qualidade_agua_grupo_g"; // nome do topico
